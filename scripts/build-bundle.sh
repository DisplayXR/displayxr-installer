...
extract_earthview_demo() {
    ...
    CHOICES+="    <choice id=\"earthview_demo\" visible=\"true\" start_selected=\"true\"
        title=\"EarthView\"
        description=\"DisplayXR demo: 3D Tiles globe renderer for glasses-free 3D displays. Installs to /Applications/EarthView.app. Optional.\">
...
# .pkg (gauss, model viewer, media player, avatar, earthview). process_component gracefully
